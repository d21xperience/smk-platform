    ...
    <div class="container q-px-md max-width-center">
      ...
      <div class="text-center q-mb-xl">
        ...
        <p class="text-body1 text-grey-7 q-mt-sm">
          Ikuti rekam jejak aktivitas, prestasi membanggakan, dan agenda resmi SMK Pasundan
          Jatinangor.
        </p>
      </div>
      ...
      <div class="row q-col-gutter-lg">
        <div v-for="(news, index) in filteredNews" :key="index" class="col-12 col-sm-6 col-md-4">
          <q-card
            class="news-public-card shadow-1 flat bordered flex flex-column justify-between bg-white"
          >
            <div>
              ...
              <q-img :src="news.cover" :ratio="16 / 10">
                <div class="absolute-bottom-left q-ma-sm q-pa-none bg-transparent">
                  <q-badge
                    :color="news.type === 'Prestasi' ? 'positive' : 'info'"
              ...
              <q-card-section class="q-pa-md">
                ...
                <div
                  class="text-subtitle1 text-weight-bold text-grey-9 lines-2 title-link q-mt-xs"
    ...
    <q-dialog v-model="detailDialogOpen" scrollable max-width="700px">
      <q-card style="width: 100%; max-width: 700px" class="bg-white rounded-borders">
        ...
        <q-card-section class="q-pa-lg scroll" style="max-height: 50vh">
          <q-badge
            :color="activeNews.type === 'Prestasi' ? 'positive' : 'info'"
          ...
          <div class="text-caption text-grey-6 row items-center q-mt-md q-mb-lg">
            <q-icon name="event" size="xs" class="q-mr-xs" /> Dipublikasikan pada:
            {{ activeNews.date }}
            <q-space />
...
const newsData = ref([
  {
    ...
    excerpt:
      'Prestasi gemilang kembali ditorehkan oleh siswa jurusan TBSM dalam ajang Honda Skill Contest 2026. Kompetisi ketat menguji ketepatan troubleshooting mesin injeksi terbaru.',
    content:
      'Prestasi gemilang kembali ditorehkan oleh siswa jurusan TBSM dalam ajang Honda Skill Contest 2026. Kompetisi ketat menguji ketepatan troubleshooting mesin injeksi terbaru.<br><br>Kepala Program TBSM menyampaikan rasa bangganya atas kedisiplinan siswa dalam berlatih di bengkel standar AHASS milik sekolah. Juara ini sekaligus mengamankan tiket menuju kompetisi mekanik tingkat nasional mewakili provinsi.',
  ...
  {
    title:
      'Kunjungan Industri Semester Genap Kelas XI ke Plant Perakitan Utama PT Astra Honda Motor',
    excerpt:
      'Siswa diajak melihat langsung alur produksi perakitan motor berskala robotik modern, guna menyelaraskan wawasan budaya kerja industri langsung sejak bangku sekolah.',
    content:
      'Siswa diajak melihat langsung alur produksi perakitan motor berskala robotik modern, guna menyelaraskan wawasan budaya kerja industri langsung sejak bangku sekolah.<br><br>Melalui kunjungan ini, diharapkan siswa memiliki gambaran nyata mengenai kedisiplinan, keselamatan kerja (K3), serta etos kerja tinggi yang diterapkan di dunia industri berskala internasional.',
    cover: 'https://unsplash.com',
    type: 'Kegiatan',
    date: '18 Mei 2026',
    author: 'Kesiswaan',
...
const filteredNews = computed(() => {
  return newsData.value.filter((news) => {
    ...
    const matchesFilter = selectedFilter.value === 'all' || news.type.includes(selectedFilter.value)
