    ...
    <div class="container q-px-md max-width-center">
      ...
      <div class="text-center q-mb-xl">
        ...
        <p class="text-body1 text-grey-7 q-mt-sm">
          Lingkungan belajar modern dengan sarana dan laboratorium berstandar industri nasional dan
          internasional.
        </p>
      </div>
        ...
        >
          <q-card class="facility-card shadow-1 flat bordered flex flex-column no-wrap bg-white">
            ...
            <q-img
              ...
              @click="bukaLightbox(facility)"
            >
              <div
                class="absolute-bottom text-subtitle2 bg-black-5 text-weight-bold row items-center justify-between"
              >
...
const facilities = ref([
  {
    ...
    description:
      'Laboratorium praktik utama TBSM yang didesain menyerupai layout bengkel resmi AHASS Honda, lengkap dengan bike lift pneumatik.',
  ...
  },
  {
    ...
    image: 'https://unsplash.com',
    description:
      'Ruang kelas khusus untuk simulasi troubleshooting kelistrikan sistem PGM-FI menggunakan papan sirkuit simulasi digital.',
  ...
  },
  {
    ...
    image: 'https://unsplash.com',
    description:
      'Lab jaringan komputer yang dilengkapi rak server fisik, puluhan router MikroTik, dan switch Cisco untuk simulasi topologi jaringan berskala besar.',
  ...
  },
  {
    ...
    image: 'https://unsplash.com',
    description:
      'Ruangan khusus ber-AC berkecepatan internet tinggi untuk melatih siswa melakukan monitoring keamanan siber dan konfigurasi cloud computing.',
  ...
  },
  {
    ...
    image: 'https://unsplash.com',
    description:
      'Ruang baca tenang yang dilengkapi puluhan tablet komputer untuk mempermudah siswa mengakses ribuan e-book materi pelajaran dan jurnal industri.',
  ...
  },
  {
    ...
    image: 'https://unsplash.com',
    description:
      'Fasilitas lapangan olahraga tertutup multifungsi untuk kegiatan turnamen futsal, basket, bulutangkis, serta acara panggung pameran seni OSIS.',
