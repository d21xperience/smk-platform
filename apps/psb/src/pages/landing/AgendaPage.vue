    ...
    <div class="container q-px-md max-width-center">
      ...
      <div class="text-center q-mb-xl">
        ...
        <p class="text-body1 text-grey-7 q-mt-sm">
          Informasi resmi mengenai jadwal kegiatan sekolah, pelaksanaan ujian, dan hari libur
          nasional.
        </p>
      </div>
      ...
      <div class="row q-col-gutter-lg">
        ...
        <div class="col-12 col-md-7">
          <q-card flat bordered class="bg-white rounded-borders shadow-1">
            <q-card-section
              class="bg-primary text-white q-py-md text-weight-bold text-subtitle1 row items-center"
            >
                ...
                <q-item v-for="(agenda, index) in agendaList" :key="index" class="q-py-md">
                  ...
                  <q-item-section avatar class="flex flex-center">
                    <div class="date-box text-center rounded-borders overflow-hidden shadow-1">
                      <div
                        class="date-month bg-primary text-white text-weight-bold text-caption uppercase"
                      >
                        {{ agenda.month }}
                      </div>
                      <div class="date-day bg-grey-2 text-grey-9 text-weight-bolder text-h6">
                        {{ agenda.day }}
                      </div>
                    </div>
                  </q-item-section>
                  ...
                  <q-item-section>
                    ...
                    <q-item-label caption class="text-grey-7 row items-center q-mt-xs">
                      ...
                      <q-icon name="place" size="xs" class="q-ml-md q-mr-xs" /> Lokasi:
                      {{ agenda.location }}
                    </q-item-label>
                  </q-item-section>
                </q-item>
        ...
        <div class="col-12 col-md-5">
          <q-card flat bordered class="bg-white rounded-borders shadow-1">
            <q-card-section
              class="bg-negative text-white q-py-md text-weight-bold text-subtitle1 row items-center"
            >
          ...
          <q-banner rounded class="bg-amber-2 text-grey-9 q-mt-lg shadow-1 border-amber">
            ...
            <div class="text-weight-bold text-caption text-sm-body2">
              Pemberitahuan: Selama Libur Akhir Semester, pelayanan administrasi Tata Usaha (TU)
              fisik di sekolah tetap buka terbatas pada jam 08.00 - 12.00 WIB.
            </div>
          </q-banner>
        </div>
      </div>
