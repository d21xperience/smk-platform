      ...
      <div class="row q-col-gutter-lg">
          ...
          <q-card flat bordered class="bg-white rounded-borders shadow-1">
            ...
            <q-img :src="jurusan.cover" :ratio="16 / 9" class="rounded-top">
              <div class="absolute-bottom-left q-ma-md q-pa-none bg-transparent">
                <q-badge
                  :color="jurusan.themeColor"
                  class="text-weight-bold q-px-md q-py-xs text-subtitle2"
                >
            ...
            <q-card-section class="q-pa-lg">
              ...
              <div class="row items-center q-mt-md text-grey-6 text-caption text-sm-body2">
                ...
                <q-badge color="green-1" text-color="green-7" class="q-ml-sm text-weight-bold"
                  >A (Sangat Baik)</q-badge
                >
              </div>
              ...
              <p
                class="text-body1 text-grey-8 line-height-relaxed"
                v-html="jurusan.description"
              ></p>

              <!-- MATERI / KURIKULUM YANG DIPELAJARI -->
              <div class="text-h6 text-weight-bold text-primary q-mt-xl q-mb-md">
                Kompetensi Inti Materi
              </div>
              <div class="row q-col-gutter-sm">
                <div
                  v-for="(materi, index) in jurusan.curriculum"
                  :key="index"
        ...
        <div class="col-12 col-md-4">
          ...
          <q-card flat bordered class="bg-white rounded-borders shadow-1 q-mb-lg">
            <q-card-section
              class="bg-primary text-white q-py-sm text-weight-bold text-subtitle1 row items-center"
            >
              <q-icon name="handshake" class="q-mr-sm" /> Sinkronisasi Industri
            </q-card-section>
            <q-card-section class="q-pa-md text-center">
              <div class="text-caption text-grey-7 q-mb-md">
                Lulusan jurusan ini terhubung dan diserap langsung oleh jaringan mitra:
              </div>
          ...
          <q-card flat bordered class="bg-white rounded-borders shadow-1 q-mb-lg">
            <q-card-section
              class="bg-dark text-white q-py-sm text-weight-bold text-subtitle1 row items-center"
            >
          ...
          >
            ...
            <div class="text-caption text-white-8 q-mt-xs">
              Kuota terbatas untuk tiap gelombang pendaftaran PPDB.
            </div>
            <q-btn
              unelevated
              color="white"
              :text-color="jurusan.themeColor"
              label="Daftar PPDB Sekarang"
              class="full-width text-weight-bold q-mt-md"
              icon="assignment"
              @click="bukaPendaftaran"
            />
          </q-card>
        </div>
      </div>
...
const masterJurusanData = {
  ...
  tkj: {
    ...
    cover: 'https://unsplash.com',
    description:
      'Jurusan Teknik Komputer & Jaringan (TKJ) memfokuskan siswa pada penguasaan instalasi perangkat keras, sistem operasi komputer, perancangan jaringan kabel dan nirkabel, administrasi server Linux/Windows, serta konsep dasar keamanan siber siber berskala enterprise.',
    curriculum: [
