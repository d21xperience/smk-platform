  ...
  <q-page padding>
    ...
    <q-card class="q-mb-md">
      <q-card-section>
        ...
        <q-chip v-if="statusTest !== null" :color="statusTest ? 'green' : 'red'" text-color="white" class="q-ml-sm">
      ...
      <div class="col-12 col-md-4">
        <q-card>
          <q-card-section>
            ...
            <q-linear-progress v-if="progress.siswa > 0 && progress.siswa < 100" :value="progress.siswa / 100"
              color="primary" class="q-mt-sm" />
            <p class="text-caption">{{ progress.siswa > 0 ? `${progress.siswa}%` : 'Belum dimulai' }}</p>
            <q-btn color="primary" label="Tarik Siswa" @click="tarikData('siswa')" :disable="syncing.siswa">
      ...
      <div class="col-12 col-md-4">
        <q-card>
          <q-card-section>
            ...
            <q-linear-progress v-if="progress.gtk > 0 && progress.gtk < 100" :value="progress.gtk / 100"
              color="secondary" class="q-mt-sm" />
            <p class="text-caption">{{ progress.gtk > 0 ? `${progress.gtk}%` : 'Belum dimulai' }}</p>
            <q-btn color="secondary" label="Tarik GTK" @click="tarikData('gtk')" :disable="syncing.gtk">
      ...
      <div class="col-12 col-md-4">
        <q-card>
          <q-card-section>
            ...
            <q-linear-progress v-if="progress.rombel > 0 && progress.rombel < 100" :value="progress.rombel / 100"
              color="accent" class="q-mt-sm" />
            <p class="text-caption">{{ progress.rombel > 0 ? `${progress.rombel}%` : 'Belum dimulai' }}</p>
            <q-btn color="accent" label="Tarik Rombel" @click="tarikData('rombel')" :disable="syncing.rombel">
