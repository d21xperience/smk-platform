<!--
FILE: src/pages/journal/JournalPage.vue
STATUS: MODIFY
...
<template>
  <q-page padding>
    ...
    <div class="row items-center justify-between q-mb-md">
      <div class="text-h5">Teaching Journal</div>
      ...
      <q-list v-else separator>
        <q-item v-for="session in sessions" :key="session.id" clickable v-ripple @click="handleNavigate(session.id)">
          <q-item-section avatar>
            <q-icon name="book" color="primary" size="2em" />
          </q-item-section>
          ...
          <q-item-section side>
            <q-btn color="primary" :label="isReadOnlyContext ? 'Lihat' : 'Jurnal'" size="sm"
