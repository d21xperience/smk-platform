  ...
  <q-page class="q-pa-md dashboard-page">
    ...
    <template v-else>
      ...
      <div class="row q-col-gutter-md q-mb-md">
        <div class="col-6 col-md-3" v-for="(stat, index) in dashboardData.stats" :key="index">
        ...
        <div class="col-12 col-md-5">
          <q-card flat bordered class="full-height">
            <q-card-section>
              ...
              <q-list separator v-if="dashboardData.todaySchedule.length">
                <q-item v-for="jadwal in dashboardData.todaySchedule" :key="jadwal.id">
                  ...
                  <q-item-section side>
                    <q-badge :color="jadwal.status === 'selesai' ? 'positive' : 'grey-5'" outline>
                      {{ jadwal.status === 'selesai' ? 'Selesai' : 'Belum' }}
                    </q-badge>
                  </q-item-section>
                </q-item>
              </q-list>
      ...
      <div class="q-mt-md">
        ...
        <div class="row q-col-gutter-md">
          ...
          <div class="col-12" v-if="dashboardData.criticalAlerts.length === 0">
...
import { useDashboard } from '@/composables/siakad/useDashboard'
import { useUtils } from '@/composables/helper/useUtils'
const auth = useAuth()
const { loading, dashboardData, fetchOverview } = useDashboard()
