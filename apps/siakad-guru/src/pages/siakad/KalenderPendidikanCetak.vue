  ...
  <q-page class="print-calendar-page q-pa-md">
    ...
    <div class="row items-center justify-between q-mb-md wrap q-gutter-sm no-print">
      <div>
        ...
        <div class="text-caption text-grey-6">Tahun Ajaran {{ academicYear }} &middot; Tampilan Cetak</div>
      </div>
      <div class="row q-gutter-sm">
        <q-btn no-caps outline color="primary" icon="calendar_month" label="Tampilan Interaktif" :to="{ name: 'kalender-akademik' }" />
    ...
    <div class="print-header q-mb-md">
      ...
      <div class="text-subtitle2 text-grey-8">SMK Pasundan Jatinangor &middot; Tahun Ajaran {{ academicYear }}</div>
    </div>
    ...
    <div class="row q-col-gutter-md q-mb-lg">
      <div class="col-12 col-sm-6 col-md-4" v-for="m in semester1Months" :key="`${m.year}-${m.month}`">
    ...
    <div class="row q-col-gutter-md q-mb-lg">
      <div class="col-12 col-sm-6 col-md-4" v-for="m in semester2Months" :key="`${m.year}-${m.month}`">
        <q-card flat bordered class="month-card">
          <q-card-section>
            <MonthCalendarGrid
              :year="m.year"
    ...
    <q-card flat bordered class="q-pa-md">
      ...
      <div class="row q-gutter-md">
        <div v-for="cat in categories" :key="cat.value" class="row items-center q-gutter-xs">
          <div class="legend-swatch" :style="{ backgroundColor: cat.fill, borderColor: cat.text }" />
...
import { academicYear, CALENDAR_CATEGORIES, semesterData, getAllEvents } from '@/data/academicCalendarData'
