        ...
        <div class="login-card__inner">
          ...
          <div class="form-panel">
            ...
            <q-form @submit="handleLogin" class="q-gutter-md">
              ...
              <!-- PILIHAN ROLE (SIMULASI UNTUK DEVELOPMENT / PROTOTYPE) -->
              <!-- Catatan: Pada sistem produksi asli, role akan otomatis ditentukan oleh Server/API backend -->
              <div class="dev-mode-box q-pa-sm">
                <div class="row items-center text-caption text-grey-7 q-mb-xs">
                  <q-icon name="construction" size="16px" class="q-mr-xs" />
                  Mode pengembangan &mdash; simulasi hak akses
                </div>
                <q-select outlined dense v-model="loginForm.simulatedRole" :options="roleOptions" label="Role"
                  emit-value map-options>
                  <template v-slot:prepend>
                    <q-icon name="verified_user" color="amber-9" size="20px" />
                  </template>
                </q-select>
              </div>
...
// Opsi Pilihan Hak Akses untuk Pengembangan
const roleOptions = [
  { label: 'Super Admin (Kepala Sekolah/IT)', value: 'admin' },
  { label: 'Tata Usaha (Panitia PPDB)', value: 'tu' },
  { label: 'Kepala Program Jurusan (TBSM/TKJ)', value: 'kaprog' },
  { label: 'Pengurus OSIS (Mading Kontributor)', value: 'osis' },
  { label: 'Guru (Kontributor Berita/Artikel)', value: 'guru' }
]
