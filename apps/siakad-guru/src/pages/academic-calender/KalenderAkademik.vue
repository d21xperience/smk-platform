  ...
  <q-page class="calendar-page q-pa-md">
    ...
    <div class="row items-center justify-between q-mb-md wrap q-gutter-sm">
      ...
      <div class="row items-center q-gutter-sm">
        <q-btn-toggle v-model="viewMode" no-caps unelevated toggle-color="primary" color="white" text-color="grey-8"
          :options="[
        ...
        <q-btn no-caps flat color="primary" icon="print" label="Kalender Cetak"
    ...
    <q-card flat bordered class="q-mb-md">
      <q-tabs v-model="activeSemester" class="text-grey-7 semester-tabs" active-color="primary"
        indicator-color="primary" no-caps align="justify">
                ...
                <div class="row q-col-gutter-sm q-mb-md">
                  ...
                  <div class="col-12 col-sm-6">
                    <div class="row q-gutter-xs items-center category-filter">
                      <q-chip v-for="cat in categories" :key="cat.value" clickable square
                        :outline="filterCategory !== cat.value" :color="cat.color"
                        :text-color="filterCategory === cat.value ? 'white' : cat.color" class="q-px-sm"
                ...
                <template v-if="viewMode === 'grid'">
                  <div class="row items-center justify-between q-mb-sm wrap">
                    <div class="row items-center q-gutter-xs">
                      ...
                      <div class="text-subtitle1 text-weight-bold month-label">
                        {{ monthLabel(sem) }}
                      </div>
                  ...
                  <MonthCalendarGrid :year="currentMonth[sem].year" :month="currentMonth[sem].month"
                    :events="filteredEvents(sem)" variant="interactive" week-start="monday" @day-click="openDay" />
                </template>
