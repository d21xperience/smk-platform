...
============================================================ -->
<template>
  <section id="jurusan" :class="['jurusan-section q-py-xl', $q.dark.isActive ? 'bg-dark' : 'bg-grey-1']">
              ...
              <q-card-section class="col-12 col-sm-7 q-pa-lg flex flex-column justify-between">
                <div>
                  ...
                  <div class="row items-start justify-between no-wrap q-mb-md">
                    <div>
                      <div class="text-caption text-weight-bold text-grey-5 letter-spacing-wide text-uppercase q-mb-xs">
                        Program Keahlian
                      </div>
                    ...
                    <q-chip
                      dense square
                      :color="j.color" text-color="white"
...
<style scoped>
.jurusan-carousel { border-radius: 16px; }
...
.jurusan-img-wrap { min-height: 240px; }

.jurusan-img { height: 100%; min-height: 240px; }

.jurusan-img-overlay {
  background: linear-gradient(transparent, rgba(0,0,0,.6));
}

.jurusan-tab-chip { transition: all .2s; cursor: pointer; }
.jurusan-tab-chip:hover { transform: translateY(-2px); }

.border-top { border-top: 1px solid rgba(0,0,0,.08); }
.dark-text { color: var(--q-grey-9) !important; }
.body--dark .dark-text { color: #e0e0e0 !important; }
.body--dark .border-top { border-color: rgba(255,255,255,.08); }
...
@media (max-width: 599px) {
  .q-col-jurusan { flex-direction: column; }
}
</style>
